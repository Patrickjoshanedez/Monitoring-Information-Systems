          ...
          <div className="tw-space-y-8">
            ...
            <div className="tw-space-y-4">
              <div className="tw-flex tw-items-start tw-gap-4 tw-p-4 tw-border tw-border-primary/20 tw-rounded-xl">
                ...
                <p className="tw-text-gray-700 dark:tw-text-slate-200">Click "Register", enter student email and password</p>
              </div>
              ...
              <div className="tw-flex tw-items-start tw-gap-4 tw-p-4 tw-border tw-border-primary/20 tw-rounded-xl">
                ...
                <p className="tw-text-gray-700 dark:tw-text-slate-200">Verify email with Code</p>
              </div>
              ...
              <div className="tw-flex tw-items-start tw-gap-4 tw-p-4 tw-border tw-border-primary/20 tw-rounded-xl">
                ...
                <p className="tw-text-gray-700 dark:tw-text-slate-200">Choose your role</p>
              </div>
              ...
              <div className="tw-flex tw-items-start tw-gap-4 tw-p-4 tw-border tw-border-primary/20 tw-rounded-xl">
                ...
                <p className="tw-text-gray-700 dark:tw-text-slate-200">Fill up application form</p>
              </div>
              ...
              <div className="tw-flex tw-items-start tw-gap-4 tw-p-4 tw-border tw-border-primary/20 tw-rounded-xl">
                ...
                <p className="tw-text-gray-700 dark:tw-text-slate-200">Wait for the approval</p>
              </div>
            </div>
          </div>
          ...
          <div className="tw-relative">
            <div className="tw-bg-gradient-to-br tw-from-purple-100 tw-to-purple-200 tw-rounded-2xl tw-p-8 tw-h-96 tw-flex tw-items-center tw-justify-center dark:tw-from-purple-900/40 dark:tw-to-purple-700/30">
              <div className="tw-text-center tw-space-y-4">
                ...
                <p className="tw-text-gray-600 dark:tw-text-slate-200">Mentoring Process</p>
              </div>
            </div>
          </div>
        </div>
